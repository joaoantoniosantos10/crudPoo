...
include_once("REPOSITORY/produtoRepository.phpRepository.php");
$id = null;
$produtoRepository = new CategoriaRepository();
    ...
    <table style="padding: 5em;" class="table">
        ...
        <?php foreach($produtos as $produto){ ?>
            ...
            <tr>
                ...
                <td>
                    <a href="editarCategoria.php?id=<?php echo $produto["id"]; ?>" class="btn btn-success">Editar</a>
                </td>
                <td>
                    <a href="DELETE/deletarCategoria.php?id=<?php echo $produto["id"]; ?>" class="btn btn-danger">Deletar</a>
                </td>
            </tr>
            </tbody>
        <?php } ?>
